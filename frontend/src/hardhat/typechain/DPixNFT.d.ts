...
interface DPixNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class DPixNFT extends Contract {
  ...
  creatorOf(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
  ...
  filters: {
    ...
    SetTokenURI(tokenId: BigNumberish | null, tokenURI: null): EventFilter;
